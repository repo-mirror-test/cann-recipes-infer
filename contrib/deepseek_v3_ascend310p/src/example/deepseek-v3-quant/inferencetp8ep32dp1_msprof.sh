...
LAUNCH_PY="$SCRIPT_DIR/../../launch_inference_msprof.py"
python "$LAUNCH_PY" --config "$SCRIPT_DIR/inference_run_config_tp8_ep32_dp1.yaml" --data_path "$SCRIPT_DIR/../../HumanEval.jsonl" --batchSize 1
