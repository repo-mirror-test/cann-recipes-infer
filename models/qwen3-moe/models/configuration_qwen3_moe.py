...
# (https://github.com/huggingface/transformers/blob/v4.53.0/src/transformers/models/qwen3_moe/configuration_qwen3_moe.py)
...
class Qwen3MoeConfig(PretrainedConfig):
    ...
    of [Qwen/Qwen3-15B-A2B](https://huggingface.co/Qwen/Qwen3-15B-A2B).
