...
镜像版本：cann8.5_pt2.6.0_dsv3.2_aarch_image:v0.5
...
### 获取 docker 镜像
  从[ARM镜像地址](https://cann-ai.obs.cn-north-4.myhuaweicloud.com/cann-quantization/DeepSeek-V3.2-Exp/cann8.5_pt2.6.0_dsv3.2_aarch_image_v0.5.tar)中下载 docker 镜像，然后上传到A3服务器的每个节点上，并通过命令导入镜像 `docker load -i cann8.5_pt2.6.0_dsv3.2_aarch_image_v0.5.tar`。
